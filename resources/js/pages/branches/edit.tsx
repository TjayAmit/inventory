...
import { index as branchesIndex, update as branchesUpdate } from '@/routes/branches';
import type { BranchEditProps } from '@/types';

export default function Edit({ branch, managers }: BranchEditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (branch) {
            put(branchesUpdate.url(branch.id));
        }
    };
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the branch details.</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update branch settings.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
