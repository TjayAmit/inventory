...
import type { InventoryEditProps } from '@/types';

export default function Edit({ inventory, products, branches }: InventoryEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        product_id: String(inventory.product_id),
        branch_id: String(inventory.branch_id),
        quantity_on_hand: String(inventory.quantity_on_hand),
        quantity_reserved: String(inventory.quantity_reserved),
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(inventoryUpdate.url(inventory.id));
    };

    return (
        <>
            <Head title="Edit Inventory Record" />
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4 lg:p-6 max-w-4xl mx-auto">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight">Edit Inventory Record</h1>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the product and branch for this inventory record.</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the stock quantities and cost information.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update additional dates and settings.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
