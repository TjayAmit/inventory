...
import { index as salesItemsIndex, store as salesItemsStore } from '@/routes/sales-items';
import type { SalesItemFormProps } from '@/types/sales-item';

export default function Create({ salesOrders, products, inventoryBatches }: SalesItemFormProps) {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4 lg:p-6 max-w-4xl mx-auto">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight">Create Sales Item</h1>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Select the sales order and product for this item.</CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Enter quantity, pricing, and cost information.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Creating...' : 'Create Sales Item'}
                        </Button>
                        <Link href={salesItemsIndex()}>
