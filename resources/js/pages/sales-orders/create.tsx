...
import { index as salesOrdersIndex, store as salesOrdersStore } from '@/routes/sales-orders';
import type { SalesOrderFormProps } from '@/types/sales-order';
import { useEffect, useState } from 'react';

export default function Create({ branches, cashiers }: SalesOrderFormProps) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Enter the payment and pricing information.</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Add any notes or comments about this order.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-2">
